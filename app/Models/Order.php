...
class Order extends Model
{
    ...
    public function scopeAwtReturnOrder($query)
    {
        return $query->where('order_status',['accepted','confirmed','processing','handover','picked_up'])->where('awt_return_order_reason','!=','n/a');
    }
