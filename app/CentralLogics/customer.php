...
class CustomerLogic
{
    public static function create_wallet_transaction($user_id, float $amount, $transaction_type, $referance)
    {
        ...
        } else if (in_array($transaction_type, ['order_place', 'deduct_fund_by_admin'])) {
            $debit = $amount;
        }
        ...
        try {
            ...
            DB::commit();
            if (in_array($transaction_type, ['loyalty_point', 'order_place', 'add_fund_by_admin', 'deduct_fund_by_admin', 'referrer', 'add_fund']))
