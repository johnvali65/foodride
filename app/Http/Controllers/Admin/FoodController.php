...
class FoodController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $food->petpooja_add_ons = $request->has('addon_groups') ? ($request->addon_groups) : json_encode([]);
        $food->options = $request->has('option_ids') ? json_encode($request->option_ids) : json_encode([]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $p->petpooja_add_ons = $request->has('addon_groups') ? ($request->addon_groups) : json_encode([]);
        $p->options = $request->has('option_ids') ? json_encode($request->option_ids) : json_encode([]);
