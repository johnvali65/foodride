...
class CustomerWalletController extends Controller
{
    ...
    public function add_fund(Request $request)
    {
        ...
        if ($request->transaction_type == 'debit') {
            $transaction_type = 'deduct_fund_by_admin';
            $success_message = translate('messages.fund_deducted_successfully');
        } else {
            $transaction_type = 'add_fund_by_admin';
            $success_message = translate('messages.fund_added_successfully');
        }
        $wallet_transaction = CustomerLogic::create_wallet_transaction($request->customer_id, $request->amount, $transaction_type, $request->referance);
