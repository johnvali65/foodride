...
class CustomerController extends Controller
{
    ...
    public function settings()
    {
        $data = BusinessSetting::where('key','like','wallet_%')
            ...
            ->orWhere('key','like','ref_earning_%')
            ->orWhere('key','like','cancellation_time_period%')
            ->orWhere('key','like','referee_earning_rate%')
            ->get();
    ...
    public function update_settings(Request $request)
    {
        ...
        BusinessSetting::updateOrInsert(['key' => 'referee_earning_rate'], [
            'value' => $request['referee_earning_rate'] ?? 0
        ]);
        ...
        BusinessSetting::updateOrInsert(['key' => 'cancellation_time_period'], [
            'value' => $request['cancellation_time_period']??0
        ]);
