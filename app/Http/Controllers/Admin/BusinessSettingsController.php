...
class BusinessSettingsController extends Controller
{
    ...
    public function app_settings_latest()
    {
        $settings = (new AppSetting)->orderBy('id', 'desc')->get();
        return view('admin-views.app-settings.index', compact('settings'));
    }
    
    public function edit_app_settings($id) 
    {
        $setting = (new AppSetting)->getDataById($id);
        return view('admin-views.app-settings.edit', compact('setting'));
    }
    
    public function update_app_settings_latest(Request $request, $id) 
    {
