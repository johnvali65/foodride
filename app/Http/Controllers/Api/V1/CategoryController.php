...
class CategoryController extends Controller
{
    ...
    public function awt_get_products($id, Request $request)
    {
        ...
        $data = CategoryLogic::awt_products($id, $zone_id, $request['limit'], $request['offset'], $type);
...
/**/        
        ...
        $data = CategoryLogic::restaurants($id, $zone_id, $request['limit'], $request['offset'], $type, $scheduled_day_no);
        $data['restaurants'] = Helpers::restaurant_data_formatting($data['restaurants'] , true);
        return response()->json($data, 200);
    }
