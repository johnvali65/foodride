...
class AddOnController extends Controller
{
    public function list(Request $request)
    {
        ...
        foreach ($addons as $value) {
            if($value->addon_group_id) {
                $value->addon_group_name = AddonGroup::where('id', $value->addon_group_id)->value('group_name');
            } else {
                $value->addon_group_name = '';
            }
        }
    ...
    public function store(Request $request)
    {
        ...
        $addon->addon_group_id = $request->addon_group_id;
        $addon->veg = $request->addon_type ?? 1;
        $addon->save();
